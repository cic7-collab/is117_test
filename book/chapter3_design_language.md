...
```mermaid
timeline
    title Modernism, Postmodernism, and Continuing Visual Tensions
    1890s-1910s : Industrialization and new media
                : Arts and Crafts, Art Nouveau, Futurism, Constructivism and other experiments
    1919 : Bauhaus founded
         : Art, craft, technology, architecture and design education brought into dialogue
    1920s-1930s : De Stijl and Constructivist experiments
                : Modernist ideas spread through graphic design and architecture
    1940s-1960s : Swiss / International Typographic Style
                : Grid, asymmetry, sans-serif type, hierarchy, clarity
    1960s-1970s : Growing challenges to modernist universality
                : New approaches to identity, culture, expression and communication
    1970s-1980s : Postmodern graphic design
                : Plurality, quotation, disruption, expressive typography, irony
    1990s-2000s : Digital tools expand visual possibilities
                : Web design develops new relationships among type, image, code and interaction
    2010s-2020s : Design systems and expressive digital cultures coexist
                : Grid-based interfaces meet experimental typography, motion, collage and identity
    Today : Modernist and postmodern strategies remain available
          : Designers move between order and disruption according to context
```
...
flowchart TD
    ...
    B --> F[Modernist Strategies]
    C --> G[Postmodern Strategies]
    F --> H[Contemporary Digital Design]
    G --> H
    D --> H
    E --> H
```
